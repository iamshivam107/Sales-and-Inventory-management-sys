		...
		<div class="row">
			<div class="col-md-4">
				<div class="card mx-auto">
				  <img class="card-img-top mx-auto" style="width:90%;" src="./images/dashboard_img.png" alt="Card image cap">
				  <div class="card-body">
				    <h4 class="card-title">Profile Info</h4>
				    <p class="card-text"><i class="fa fa-user">&nbsp;</i>Shivam Jha</p>
			...
			<div class="col-md-8">
				<div class="jumbotron" style="width:100%;height:100%;">
					...
					<div class="row">
						<div class="col-sm-6">
							<img src="./images/new.png" style="width:100%;height:100%;">
                        </div>
